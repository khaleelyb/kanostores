        ...
        {tab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
                <h3 className="font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"><span className="w-2 h-2 bg-blue-500 rounded-full" />Top Categories</h3>
                <div className="space-y-3">
              ...
              <div className="divide-y divide-gray-50 dark:divide-gray-800">
                {filteredOrders.map(o => {
                  ...
                  const orderText = [
                    ...
                    o.buyerEmail ? `*Buyer Email:* ${o.buyerEmail}` : null,
                    o.buyerAddress ? `*Delivery Address:* ${o.buyerAddress}` : null, ``,
                    o.korapayReference ? `*Payment Ref:* ${o.korapayReference}` : null,
                        ...
                        <div className="flex items-start gap-4">
                          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 overflow-hidden flex-shrink-0">
                            {product?.images?.[0]
                              ...
                              : <div className="w-full h-full flex items-center justify-center text-gray-400"><svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" /></svg></div>
                            }
                          </div>
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-3 flex-wrap">
                              ...
                              <button onClick={() => setExpandedOrderId(isExpanded ? null : o.id)} className="text-xs font-semibold text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 px-3 py-1.5 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                             ...
                             {sellerWhatsApp && (
  <a
    href={`https://wa.me/${sellerWhatsApp}?text=${encodeURIComponent(orderText)}`}
    target="_blank"
    rel="noopener noreferrer"
    className="text-xs font-semibold text-green-600 hover:text-white bg-green-50 dark:bg-green-900/20 hover:bg-green-500 dark:hover:bg-green-600 px-3 py-1.5 rounded-lg border border-green-200 dark:border-green-800 transition-all flex items-center gap-1"
  >
    <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          <td className="px-5 py-3 text-right">
                            <div className="flex items-center justify-end gap-2">
                              <button
                                ...
                                className="text-xs font-semibold text-blue-500 hover:text-white hover:bg-blue-500 px-2.5 py-1 rounded-lg border border-blue-200 dark:border-blue-800 transition-all"
                              >
                                Edit
                              </button>
                              <button
                                onClick={() => setConfirmDelete({ type: 'product', id: p.id, name: p.title })}
                                className="text-xs font-semibold text-red-500 hover:text-white hover:bg-red-500 px-2.5 py-1 rounded-lg border border-red-200 dark:border-red-800 transition-all"
                              >
                                Delete
                              </button>
                            </div>
                    ...
                    <div key={u.id} className="px-3 sm:px-5 py-3 sm:py-4 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                        <div className="relative flex-shrink-0">
                          ...
                          {boosted && <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-amber-400 rounded-full border-2 border-white dark:border-gray-900 flex items-center justify-center"><svg className="w-2 h-2 text-white" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" d="M9 4.5a.75.75 0 0 1 .721.544l.813 2.846a3.75 3.75 0 0 0 2.576 2.576l2.846.813a.75.75 0 0 1 0 1.442l-2.846.813a3.75 3.75 0 0 0-2.576 2.576l-.813 2.846a.75.75 0 0 1-1.442 0l-.813-2.846a3.75 3.75 0 0 0-2.576-2.576l-2.846-.813a.75.75 0 0 1 0-1.442l2.846-.813A3.75 3.75 0 0 0 7.466 7.89l.813-2.846A.75.75 0 0 1 9 4.5Z" clipRule="evenodd" /></svg></span>}
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          {boosted && u.boostedUntil && (
                            <p className="text-xs text-amber-500 mt-0.5">Boosted until {new Date(u.boostedUntil).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</p>
                          )}
                        </div>
                        {!isMe && (
                          <div className="flex items-center gap-2 flex-shrink-0 flex-wrap">
                            <button onClick={() => handleToggleVerified(u)}
                            ...
                            {boosted ? (
                              <button onClick={() => handleRemoveBoost(u.id)}
                              ...
                              <button onClick={() => setBoostPickerUserId(showBoostPicker ? null : u.id)}
                            ...
                            <button onClick={() => setConfirmDelete({ type: 'user', id: u.id, name: u.name })}
                              className="flex items-center gap-1 text-xs font-semibold text-red-500 hover:text-white bg-red-50 dark:bg-red-900/20 hover:bg-red-500 dark:hover:bg-red-600 px-3 py-1.5 rounded-lg border border-red-200 dark:border-red-800 transition-all duration-200">
